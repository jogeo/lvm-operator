...
1. Pick one file to migrate (suggest starting with a smaller one)
2. Use Phase 1 (drop-in) first
3. Run tests to verify
4. Gradually adopt Phase 2 for better code quality
5. Once all files migrated, remove `github.com/openshift/origin` from go.mod
